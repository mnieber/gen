...
def get_helpers(_):
    class Helpers:
        ...
        form_input_field_specs = inputs_type_spec.get_field_specs(["form"])
        ...
        def mutation_fixture_imports(self):
            ...
            for form_field_spec in self.form_input_field_specs:
                django_module = form_field_spec.target_item_type.django_module
                ...
                for fk_field_spec in fk_field_specs_for_form_field(form_field_spec):
                    django_module = fk_field_spec.target_item_type.django_module
                    import_path = f"{django_module.module_path}.tests.random_data"
                    result.append(
