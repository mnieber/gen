...
class WidgetSpecParser:
    ...
    def parse(
        self, widget_spec_dict, parent_widget_spec=None, parent_builder=None, level=0
    ):
        ...
        for key, value in items:
            ...
            returned_widget_specs.append(widget_spec)
